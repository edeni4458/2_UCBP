    ...
    return (
            <div className="main-container">
                <div className="first-top-width">
                    ...
                    <img className="fix-image" src={phatomCigar4} alt="solid snake" />
                </div>
                <div className="top-sub-container">
                    ...
                    <div className="social-media-links">
                        <div className="social-media-cards">
                            <a href="https://www.youtube.com/@UnderTheCardboardBox" target='_blank' rel="noreferrer"><img className='codec-image-U' src={youtube} alt="Spotify logo" /></a>
                        </div>
                        <div className="social-media-cards">
                            <a href="https://open.spotify.com/show/2aIiRya7gIuVEQ2MnPi7iY" target='_blank' rel="noreferrer"><img className='codec-image-spot' src={spotify} alt="Spotify logo" /></a>
                        </div>
                        <div className="social-media-cards">
                            <a href="https://www.podchaser.com/podcasts/under-the-cardboard-box-a-meta-69852" target='_blank' rel="noreferrer"><img className='codec-image' src={podchaser} alt="Podchaser logo" /></a>
                        </div>
                        <div className="social-media-cards">
                            <a href="https://podcasts.google.com/feed/aHR0cHM6Ly91bmRlcnRoZWNhcmRib2FyZGJveC5wb2RvbWF0aWMuY29tL3JzczIueG1s" target='_blank' rel="noreferrer"><img className='codec-image' src={google} alt="Google logo" /></a>
                        </div>
                        <div className="social-media-cards">
                            <a href="https://podcasts.apple.com/us/podcast/under-the-cardboard-box-a-metal-gear-solid-podcast/id1059651069" target='_blank' rel="noreferrer"><img id='apple-img' className='codec-image' src={apple} alt="Apple logo" /></a>
                        </div>
                    </div>
                </div>
